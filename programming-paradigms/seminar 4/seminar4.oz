...
% Concat pair to: Original list without the Pair.1 
declare
fun {AddJoin Env Pair}
   Pair | {List.filter Env
	   fun {$ Elem} {Not Elem.1 == Pair.1} end}
end

{Browse {AddJoin [a#1 b#2 c#3] c#4}}
{Browse {AddJoin [a#1 b#2 c#3] d#4}}
